  ...
  return (
    <aside className="w-60 min-h-screen bg-gray-900 flex flex-col p-4 border-r border-gray-800">
      <div className="mb-8">
        ...
        <p className="text-gray-400 text-sm mt-1 truncate">{fullName}</p>
      ...
      <button onClick={handleLogout} className="text-gray-500 hover:text-red-400 text-sm mt-4 text-left px-3">
        🚪 Logout
      </button>
    </aside>
  )
